...
<html lang="en-us">
	<head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<?php  echo base_url(); ?>css/estilos-jjsalud.css">
        ...
        <link rel="stylesheet" type="text/css" media="print"  href="<?php  echo base_url(); ?>css/printer.css">
		...
		<link rel="icon" href="<?php  echo base_url(); ?>img/favicon/jj_icon.ico" type="image/x-icon">
		...
		<link rel="apple-touch-startup-image" href="<?php  echo base_url(); ?>img/splash/iphone.png" media="screen and (max-device-width: 320px)">
         ...
         <link rel="stylesheet" type="text/css" media="screen" href="<?php  echo base_url(); ?>css/glyphiconos.css">   
         <link rel="stylesheet" href="<?php  echo base_url(); ?>css/bootstrap-multiselect.css" type="text/css"/>

          <link rel="stylesheet" type="text/css" href="<?php  echo base_url(); ?>js/jgrowl/jquery.jgrowl.css" media="screen" />
	...
	-->
	<body class=" desktop-detected menu-on-top   smart-style-4  pace-done  fixed-header fixed-navigation">
