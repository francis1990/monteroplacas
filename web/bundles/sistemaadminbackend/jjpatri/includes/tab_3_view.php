...
<nav>
    <ul>
        ...
        <?php if ($this->session->userdata('acceso_ventas') == 1) { ?>
            <li >
                <a class="linka1" href="<?php echo base_url() ?>venta_jjsalud/viewMenuVentas"><i class="fa fa-lg fa-fw fa-money"></i> <span class="menu-item-parent">Ventas</span></a>
            </li>
        <?php } ?>
       
        <?php if ($this->session->userdata('acceso_logistica') == 1) { ?>
            <li>
                <a class="linka1" href="<?php echo base_url() ?>logistica_jjsalud/viewMenuLogistica"><i class="fa fa-lg fa-fw fa-truck"></i> <span class="menu-item-parent">Logistica</span></a>
            </li>
        <?php } ?>
        <?php if ($this->session->userdata('acceso_contabilidad') == 1) { ?>
            <li>
                <a class="linka1" href="<?php echo base_url() ?>contable_jjsalud/viewMenuContableVoucher"><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> <span class="menu-item-parent">Contabilidad</span></a>
